...
echo "=== Running Rider Geospatial Location Telemetry TestFlow ===\n";

$controller = new RiderController();

// Simulate updating coordinates for Driver ID 1
$mockInputData = [
    "driver_id" => 1,
    "latitude" => "22.7796",  // Mock coordinate pair
    "longitude" => "86.2343"
];

$controller->updateLocation($mockInputData);